...
public class DeviceEntity extends BaseEntity {
   ...
   * @param osClassification     the os classification
   * @param statusClassification the status classification
   * @param sn                   the sn
   */
  @Builder
  public DeviceEntity(DeviceTypeClassification typeClassification,
      DeviceOsClassification osClassification, DeviceStatusClassification statusClassification,
      String sn) {
