package sample.api.gateway.filter;

import sample.api.gateway.security.JwtUtils;
import sample.api.gateway.security.TokenUser;
...
public class JwtAuthenticationGlobalFilter implements GlobalFilter, Ordered {
  ...
  private static final String VERIFICATION_TARGET_PATH = "/api";
